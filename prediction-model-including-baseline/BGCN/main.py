...
def main():
    ...
    log.close()
    print(retry)
    torch.save(model.state_dict(), "net_ease_model_file_from_simple_sample.pth")
    torch.save(model, "net_ease_model_file_from_simple_sample_model.pth")
